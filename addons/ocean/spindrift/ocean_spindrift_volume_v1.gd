...
func _build_step_config() -> Dictionary:
	...
	return {
		...
		"micro_burst_rate_hz": _profile.volumetric_micro_burst_rate_hz,
		"micro_burst_mass": _profile.volumetric_micro_burst_mass,
		"micro_burst_cell_size_m": _profile.volumetric_micro_burst_cell_size_m,
...
func get_runtime_state() -> Dictionary:
	...
	return {
		...
		"micro_burst_rate_hz": _profile.volumetric_micro_burst_rate_hz if _profile != null else 0.0,
		"micro_burst_mass": _profile.volumetric_micro_burst_mass if _profile != null else 0.0,
		"micro_burst_cell_size_m": _profile.volumetric_micro_burst_cell_size_m if _profile != null else 0.0,
		"micro_injection_full_m": Simulation.MICRO_INJECTION_FULL_M,
		"micro_injection_top_m": Simulation.MICRO_INJECTION_TOP_M,
