...
const FEATURE_ROWS := [
	...
	["Breakers", &"breakers"], ["Optics", &"optics"], ["Reflections / SSPR", &"reflections"], ["Surface Detail", &"surface_detail"],
